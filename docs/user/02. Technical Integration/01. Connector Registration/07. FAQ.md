...
<br>
<br>
With the successful registration, the connector is part of the dataspace. This means, the connector can get identified by other dataspace participants and accessed only via identification.
<br>
<br>
...
The deletion of a connector is similarly to the registration, only possible if the user has enough user permissions. Ideally the company administrator or IT admin.
...
In case of a managed connector - please contact your service provider for any questions.
<br>
<br>
